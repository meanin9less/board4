...
const { posts, updateList, deleteList } = useOutletContext();
...
return (
    ...
    <form onSubmit={(e) =>  e.preventDefault() }>
        ...
        <button onClick={() =>  updateList(post.id, title, body, writer) }>수정</button>
        <button onClick={() =>  deleteList(post.id) }>삭제</button>
    </form>
    </>
);
};